...
import {integer, pgEnum, pgTable, text, timestamp, varchar, jsonb, index, unique} from "drizzle-orm/pg-core"
...
export const classes = pgTable('classes', {
    ...
    schedules: jsonb('schedules').$type<Array<Record<string, unknown>>>().notNull().default([]),
    ...timestamps
}, (table) => ({
