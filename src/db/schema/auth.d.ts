export declare const roleEnum: import("drizzle-orm/pg-core").PgEnum<["student", "teacher", "admin"]>;
export declare const user: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        imageCldPubId: import("drizzle-orm/pg-core").PgColumn<{
            name: "image_cld_pub_id";
            tableName: "user";
            dataType: "string";
            columnType: "PgText";
            data: string;
